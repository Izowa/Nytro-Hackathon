...
$sql = "SELECT posts.*, users.usersUid, users.usersPublicKey FROM posts LEFT JOIN users ON posts.usersID=users.usersID WHERE postsFeatured=1 ORDER BY postsLikes DESC LIMIT ?, ?";
